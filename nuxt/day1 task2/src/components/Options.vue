<template>
    <div class="h-screen flex justify-center items-center">
      ...
      <div class="w-[50%] mx-auto border mb-4">
        <div class="header p-3 bg-blue-900 text-white flex justify-between items-center">
    ...
    export default {
        ...
        computed : {
            ageGroup () {
                ...
                else if (this.age < 60 && this.age > 18) return `Adult`
                else if (this.age < 18) return `Young`
                else return "unknown"
            }
        },
        methods: {
